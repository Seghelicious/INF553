...
# time /home/local/spark/latest/bin/spark-submit task2_2_bkp.py $ASNLIB/publicdata/ $ASNLIB/publicdata/yelp_val.csv task2_2.csv
...
model = xgb.train(get_model_params(), train_data, 100)
...
write_to_file(output_file, prediction, test_data_val)
...
# >=3 and <4:  824
# >=4:  0
# RMSE 0.9832202476827515
# Duration :  48.50287699699402
#
# real 1m3.547s
# user 4m1.344s
# sys 0m4.896s
