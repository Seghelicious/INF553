...
business_filepath = "dataset/business.json"
output_filepath_question_a = "output/output_task3a.json"
output_filepath_question_b = "output/output_task3b.json"
